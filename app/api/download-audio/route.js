...
const connectionURL = 'wss://browser.zenrows.com?apikey=cfc9d4a3ab9e9dc75eae0a7fba89d450d8906163';
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json({ error: 'Invalid requestheadless: true' }, { status: 400 });
  }
}
...
// // // pages/api/getDownloads.js
// // import puppeteer from 'puppeteer';
// // import chromium from '@sparticuz/chromium'; // Import!
// // import fs from 'fs';
...
// //       browser = await puppeteer.launch({
// //         headless: 'new',
// //         executablePath: await chromium.executablePath(), // Use executablePath and chrominum.executablePath()
// //         args: chromium.args,                             //Use Chromiums args
// //         ignoreDefaultArgs: ['--disable-extensions'],      //Disable extensions
// //       });
